    ...
    <main>
        ...
        <div class="card">
            ...
            <div class="vertical-text sidenav-container">
                <div class="sidenav-item" style="background: black;color:aliceblue">
                    <a href="{{ URL::to($pagination['prev']['link']) }}" id="button-link">
                ...
                <div class="sidenav-item" style="background: black;color:aliceblue">
                    <a href="{{ URL::to($pagination['next']['link']) }}" id="button-link">
